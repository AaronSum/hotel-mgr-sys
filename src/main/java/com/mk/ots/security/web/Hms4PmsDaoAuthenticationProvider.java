...
public class Hms4PmsDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    public Hms4PmsDaoAuthenticationProvider() {
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails,
        ...
        HmsPmsToken hpt = null;
        try {
        	hpt = (HmsPmsToken) credentials;
        } catch (Exception e) {
        ...
        if (!passwordEncoder.isPasswordValid(userDetails.getPassword(), presentedPassword, salt)) {
        	...
        	HmsPmsToken hptoken = null;
        	if (null != hpt) {
        		hptoken = DESUtils.decryptTokenByDES(hpt.getToken());
        		if ((new Date().getTime() - hptoken.getTimes() < DESUtils.timeoutTimestamp) 
        				&& hptoken.getLoginname().equals(hpt.getLoginname())) {
        			return;
        		}
        		throw new BadCredentialsException(messages.getMessage(
                        "AbstractUserDetailsAuthenticationProvider.badCredentials", "Bad credentials"), userDetails);
