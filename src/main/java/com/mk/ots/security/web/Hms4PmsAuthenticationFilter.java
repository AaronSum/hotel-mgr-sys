 ...
 * @since 3.0
 */
public class Hms4PmsAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Hms4PmsAuthenticationFilter() {
       super("/resources/j_spring_security_check");
    }
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        if (StringUtils.isNoneBlank(token)) {
        	...
        	hpt.setLoginname(username);
        	authRequest = new UsernamePasswordAuthenticationToken(username, hpt);
        } else {
    ...
    /**
     * get times from request
     * @param request request
     * @return times
     */
    protected String obtainTimes(HttpServletRequest request) {
        return request.getParameter("times");
    }
